...
sed -i "s/\.\.\/workspace/\/home\/${USER}\/workspace/" /opt/xmind/XMind_i386/XMind.ini
sed -i "s/^\.\./\/opt\/xmind/" /opt/xmind/XMind_i386/XMind.ini
sed -i "s/^\./\/opt\/xmind\/XMind_amd64/" /opt/xmind/XMind_i386/XMind.ini
