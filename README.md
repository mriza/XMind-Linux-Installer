...
3. Run the installer
..1. If you are installing on 32bit system, run `sudo xmind-i386-installer.sh username`
..2. If you are installing on 64bit system, run `sudo xmind-amd64-installer.sh username`
..3. Or if you are unsure about the version, the script will detect your system version automatically, run `sudo xmind-installer.sh username`
